    ...
    Rectangle {
        ...
        GridLayout {
            ...
            Item {
                ...
                //     onClicked: {
                //         // 在录制前强制设置媒体格式
                //         var format = captureControls.captureSession.recorder.mediaFormat
                //         format.fileFormat = MediaFormat.WebM
                //         format.audioCodec = MediaFormat.AudioCodec.Vorbis
                //         format.videoCodec = MediaFormat.VideoCodec.VP8
                //         captureControls.captureSession.recorder.mediaFormat = format
                //         captureControls.captureSession.recorder.record()
                //     }
                // }
                CameraButton {
                    text: "Record"
